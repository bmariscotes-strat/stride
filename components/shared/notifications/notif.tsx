  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="relative flex items-center justify-center p-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-full transition-colors duration-200"
